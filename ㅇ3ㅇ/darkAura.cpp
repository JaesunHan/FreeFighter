...
HRESULT darkAura::init(float radius, int numParticles, const WCHAR * filePath, D3DXVECTOR3 pos)
{
	_radius = radius;
	_size = 0.25f;
	_vbSize = 2048;
...
void darkAura::update(float timeDelta)
{
...
void darkAura::resetParticle(PARTICLE_ATTRIBUTE * attr)
{
